...
console.log("REMOVE 2 & 3 INSERT FORD & HONDA: ", carsInReverse);

// push
// Use the push method to add the types of cars that you removed using the splice method to the carsInReverse array.
carsInReverse.push('Mitsubishi', 'Nissan')
console.log("ADD BACK CARS REMOVED: ", carsInReverse);

// pop
// Use the pop method to remove and console.log the last item in the array carsInReverse.
carsInReverse.pop();
console.log("REMOVE LAST ITEM: ", carsInReverse);

// shift
// Use the shift method to remove and console.log the first item in the array carsInReverse.
carsInReverse.shift();
console.log("REMOVE FIRST ITEM: ", carsInReverse);

// unshift
// Use the unshift method to add a new type of car to the array carsInReverse.
carsInReverse.unshift('Acura');
console.log("ADD NEW CAR: ", carsInReverse);

// forEach
carsInReverse.forEach(function(element) {
...
console.log("ADD 2  TO THE ARRAY: ", numbers);
